...
@Service
public class Form109495BScripsTransmittalForm extends TransmittalForm {

	public static final String XSD_DOC = "src/main/resources/2022/MSG/IRS-Form1094-1095BTransmissionSCRIPSIntakeMessage.xsd";
	...
	public Object unmarshall(String _file) throws FileNotFoundException, JAXBException {
		requestObj = getJaxbUnmarshaller()
			.unmarshal(new StreamSource(_file), Form109495BTransmittalSCRIPSType.class).getValue();
		return requestObj;
	}
	...
	public Form109495BTransmittalSCRIPSType getFromType109495BScrips(String _file) throws FileNotFoundException, JAXBException {
		return (Form109495BTransmittalSCRIPSType) unmarshall(_file);
	}
