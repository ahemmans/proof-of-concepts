...
import us.gov.treasury.irs.msg.form1094_1095ctransmitterupstreammessage.ObjectFactory;

@Service
public class Form109495CTransmittalForm extends TransmittalForm {

	public static final String XSD_DOC = "src/main/resources/2022/MSG/IRS-Form1094-1095CTransmitterUpstreamMessage.xsd";
	...
	public Object unmarshall(String _file) throws FileNotFoundException, JAXBException {
		requestObj = getJaxbUnmarshaller()
			.unmarshal(new StreamSource(_file), Form109495CTransmittalUpstreamType.class).getValue();
		return requestObj;
	}
	...
	public Form109495CTransmittalUpstreamType getFormType109495C(String _file) throws FileNotFoundException, JAXBException {
		return (Form109495CTransmittalUpstreamType) unmarshall(_file);
	}
