...
@Service
public class Form109495BTransmittalForm extends TransmittalForm {

	public static final String XSD_DOC = "src/main/resources/2022/MSG/IRS-Form1094-1095BTransmitterUpstreamMessage.xsd";
	...
	public Object unmarshall(String _file) throws FileNotFoundException, JAXBException {
		requestObj = getJaxbUnmarshaller()
			.unmarshal(new StreamSource(_file), Form109495BTrnsmtUpstreamType.class).getValue();
		return requestObj;
	}
	...
	public Form109495BTrnsmtUpstreamType getFormType109495B(String _file) throws FileNotFoundException, JAXBException {
		return (Form109495BTrnsmtUpstreamType) unmarshall(_file);
	}
