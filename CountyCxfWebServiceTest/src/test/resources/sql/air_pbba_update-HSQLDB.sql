...
CREATE TABLE IFS_ERROR (
	ERROR_ID        INTEGER IDENTITY PRIMARY KEY,	    
	GSO_ID          VARCHAR(240) NOT NULL, 
	SUBMISSION_ID   INT NOT NULL,    
...
CREATE TABLE TRANSMITTER_BC (
	TRANSMITTER_BC_ID         INTEGER IDENTITY PRIMARY KEY,	   
...
CREATE TABLE TRANSMISSION_ERROR (
	TRANSMISSION_ERROR_ID  INTEGER IDENTITY PRIMARY KEY,	   
	TRANSMISSIONID_NUM     INT NOT NULL,   
	GSO_ID                 VARCHAR(240) NOT NULL,
...
CREATE TABLE TRANSMISSION_1095A (
	TRANSMISSION_1095A_ID_NUM  INTEGER IDENTITY PRIMARY KEY, 	
	TRANSMISSIONID_NUM         INT NOT NULL,   
	GSO_ID                     VARCHAR(240) NOT NULL,
...
CREATE TABLE TRANSMISSION_1095_EXT (
	TRANSMISSION_EXTID_NUM     INTEGER IDENTITY PRIMARY KEY,	  
	TRANSMISSIONID_NUM         INT NOT NULL,   
	GSO_ID                     VARCHAR(240) NOT NULL,
...
CREATE TABLE TIN_VALIDATION_ERROR (
	TIN_VAL_ERROR_ID     INTEGER IDENTITY PRIMARY KEY, 	   
	GSO_ID               VARCHAR(240) NOT NULL,
...
CREATE TABLE IR_FORM_ERROR (
	IR_FORM_ERROR_ID      INTEGER IDENTITY PRIMARY KEY,	
...
CREATE TABLE SUBMISSION_BC (
	SUBMISSION_BC_ID             	INTEGER IDENTITY PRIMARY KEY,                                       
...
INSERT INTO IFS_STATUS (GSO_ID, SUBMISSION_ID) VALUES ('001',1);
INSERT INTO SUBMISSION_BC (TRANSMITTER_BC_ID,TAX_YR,TRANSMIT_MODE_IND,UNIQUE_SUBMISSION_ID,GSO_ID,EIN,INSERTED_BY_TXT,INSERTED_DT) VALUES (1,'2023','1','1','001','123456789','int-test',CURRENT_DATE);
INSERT INTO TRANSMITTER_BC (TRANSMISSIONID_NUM,TAX_YR,UNIQUE_TRANS_ID,GSO_ID,TCC,DOC_SYSTEM_FILE_NAME_TXT,INSERTED_BY_TXT,INSERTED_DT) VALUES (1,'2023','1','001','TCC-001','blank.txt','int-test',CURRENT_DATE)
COMMIT;
