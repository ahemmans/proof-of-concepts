...
FROM AIR_DSIT_NEW.TRANSMITTER_BC A 
	...
	FULL OUTER JOIN AIR_DSIT_NEW.SUBMISSION_BC D ON C.GSO_ID = D.GSO_ID
	FULL OUTER JOIN AIR_DSIT_NEW.TIN_VALIDATION_ERROR E ON D.GSO_ID = E.GSO_ID
